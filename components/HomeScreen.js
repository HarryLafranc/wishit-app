  ...
  render () {
    return (
        <View>
          ...
          renderItem={({item}) => <TouchableOpacity onPress={() => this.props.navigation.navigate('Item', item)}><Item name={item.name} price={item.price} image={item.image} /></TouchableOpacity>}
        />
        </View>
    );
  }
